...
Route::get('/studentslogin','StudentController@studentslogin')->name('studentslogin');
Route::get('/studentsregister','StudentController@studentsregister')->name('studentsregister');
